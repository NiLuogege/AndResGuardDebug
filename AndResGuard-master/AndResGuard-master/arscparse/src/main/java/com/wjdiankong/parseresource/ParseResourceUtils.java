...
public class ParseResourceUtils {
    ...
    public static void parsePackage(byte[] src) {
        System.out.println("pchunkoffset:" + Utils.bytesToHexString(Utils.int2Byte(packageChunkOffset)) + " int= " + packageChunkOffset);
        ResTablePackage resTabPackage = new ResTablePackage();
        //解析头部信息
        resTabPackage.header = parseResChunkHeader(src, packageChunkOffset);

        System.out.println("package header:" + resTabPackage.header.toString());
        ...
        System.out.println("lastPublicType:" + resTabPackage.lastPublicType);
        ...
        System.out.println("lastPublicKey:" + resTabPackage.lastPublicKey);
